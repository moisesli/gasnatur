      ...
      <div class="p-6 sm:p-8 lg:p-16 space-y-8">
        ...
        <form class="mt-8 space-y-6" action="#" v-on:submit.prevent="sendLogin">
          ...
          <div>
            ...
            <input type="usuario" name="usuario" id="usuario" class="bg-gray-50 border border-gray-300
                   text-gray-900 sm:text-sm rounded-lg
                   outline-none focus:ring-2 focus:ring-green-500 focus:border-green-600 block w-full p-2.5" v-model="login.usuario" placeholder="mlinares" required>
          </div>
          ...
          <div>
            ...
            <input type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300
                   text-gray-900 sm:text-sm rounded-lg
                   outline-none focus:ring-2 focus:ring-green-500 focus:border-green-600 block w-full p-2.5" v-model="login.clave" required>
          </div>

          <div class="flex items-start">
            <div class="flex items-center h-5">
              <input id="remember" aria-describedby="remember" name="remember" type="checkbox" class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-green-200 h-4 w-4 rounded">
            </div>
            <div class="text-sm ml-3">
              <label for="remember" class="font-medium text-gray-900">Recordarme</label>
            </div>
          </div>
          <button type="button" @click="sendLogin()" class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-200 font-medium rounded-lg text-base px-5 py-3 w-full text-center">
