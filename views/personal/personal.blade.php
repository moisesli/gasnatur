        ...
        <table v-show="!loading.items" class="table-fixed min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase">Documento</th>
              <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase">Cargo</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr class="hover:bg-gray-100" v-for="(item, index) in items">
              ...
              <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                <div class="text-base font-semibold text-gray-900">{{ item.nombres }}, {{ item.apellidos }}<div>
                <div class="text-sm font-normal text-gray-500">{{ item.correo }}</div>
              </td>
              <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                <div class="text-base font-semibold text-gray-900">{{ item.id_tipodoc }}<div>
              </td>
              <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                <div class="text-base font-semibold text-gray-900">{{ item.id_cargo}}<div>                
              </div>
              <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
      ...
      <div class="bg-white rounded-lg shadow relative">
        ...
        <div class="flex items-start justify-between p-5 border-b rounded-t">
          <h3 class="text-xl font-semibold">
            ...
            <span v-if="modal.method=='new'">Nuevo</span>
          ...
          <form action="#">
            ...
            <div class="flex flex-col md:flex-row mt-5">
              ...
              <div class="md:w-1/3 md:ml-2.5 md:mr-2.5">                
                ...
                <select v-model="item.id_tipodoc" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-base rounded-lg outline-none focus:ring-2 focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2">
        ...
        <div class="items-center p-6 border-t border-gray-200 bg-gray-50 rounded-b">
          <button @click="storeItem()" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3">
            <i v-show="loading.store" class="fas fa-sync fa-spin fa-spin text-base mr-2"></i>
