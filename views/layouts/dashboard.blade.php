...
<head>
  ...
  <link rel="shortcut icon" type="image/jpg" href="/views/layouts/favicon.ico"/>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center">
          ...
          <a href="https://demo.themesberg.com/windster/pricing/"
             class="hidden sm:inline-flex ml-5 text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3">
            <svg class="svg-inline--fa fa-gem -ml-1 mr-2 h-4 w-4" aria-hidden="true" focusable="false" data-prefix="fas"
                 data-icon="gem" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <ul class="space-y-2 pb-2">
              ...
              <li>
                <a href="https://demo.themesberg.com/windster-pro/kanban/" target="_blank"
                  ...
                  <span
                    class="bg-gray-200 text-gray-800 ml-3 text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">2 new</span>
                </a>
              </li>
              <li>
