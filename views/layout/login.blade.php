...
<div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
    ...
    <div class="bg-white w-96 shadow-xl rounded p-5">
        <h1 class="text-3xl font-medium">Entrar al Sistema</h1>
        <p class="text-sm pt-1/2">Escribe tu correo y Contrasenia Por favor</p>
        <form class="space-y-5 mt-5">
            <input type="text" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="Correo" />
            <input type="password" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="Contrasenia" />
            <div class="">
                <a href="#!" class="font-medium text-blue-700 hover:bg-blue-300 rounded-full p-2">Olvidaste tu Contrasenia ?</a>
            </div>

            <button class="text-center w-full bg-blue-700 rounded-full text-white py-3 font-medium">Entrar al Sistema</button>

        </form>
    </div>

    <!-- Footer -->
    <p>Deseas una cuenta ? <a href="#!" class="text-blue-700 font-medium">Inscribete.</a>  </p>
</div>
