...
@section('title','Proyectos Categorias')
@section('vuejs')
  @include('categoriaprojecto.categoriaprojectojs')
@endsection
@section('content')
  @verbatim
        ...
        <table v-show="!loading.items" class="table-fixed min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase">Tipo de Proyecto</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr class="hover:bg-gray-100" v-for="(item, index) in items">
              ...
              <td class="p-4 whitespace-nowrap text-sm font-normal">
                <div class="text-base font-semibold text-gray-700">{{ item.id_tipoproyecto_name }}<div>                
              </td>
          ...
          <form action="#">
            ...
            <div class="flex flex-col md:flex-row">
              ...
              <div class="md:w-1/3 md:ml-2.5">
                <label class="text-sm font-medium text-gray-900 block mb-2">Tipo Proyecto</label>
                <select v-model="item.id_tipoproyecto" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-base rounded-lg outline-none focus:ring-2 focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5">
                  <option v-for="tipoproyecto in tipoproyectos" :value="tipoproyecto.id">{{ tipoproyecto.descripcion }}</option>                    
                </select>
              </div>              
            </div>
