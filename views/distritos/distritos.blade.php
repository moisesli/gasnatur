        ...
        <table v-show="!loading.items" class="table-fixed min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-100">
            <tr>
              ...
              <th scope="col" class="p-4 text-left text-xs font-medium text-gray-500 uppercase">Provincia</th>              
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr class="hover:bg-gray-100" v-for="(item, index) in items">
              ...
              <td class="p-4 whitespace-nowrap text-sm font-normal">
                <div class="text-base font-semibold text-gray-700">{{ item.id_provincia }}<div>                
              </td>              
          ...
          <form action="#">
            ...
            <div class="flex flex-col md:flex-row">
              <div class="md:w-1/3 md:mr-2.5">
                ...
                <input v-model="item.id" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-base rounded-lg outline-none focus:ring-2 focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2">
              </div>
              <div class="md:w-1/3 md:mr-2.5">
              ...
              <div class="md:w-1/3 md:ml-5">
                ...
                <input v-model="item.id_provincia" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-base rounded-lg outline-none focus:ring-2 focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2">
              </div>
            </div>
          </form>
        </div>
