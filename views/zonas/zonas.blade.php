    ...
    <div class="block sm:flex items-center md:divide-x md:divide-gray-100">
      ...
      <form class="sm:pr-3 mb-4 sm:mb-0" action="#" method="GET">
        ...
        <div class="mt-1 relative sm:w-64 xl:w-96">
          <input type="text" name="email" id="products-search" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Buscar Zonas">
        </div>
      </form>
