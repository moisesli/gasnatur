...
<div
  ...
  <div class="flex items-center mb-4 sm:mb-0">
    <a href="#" @click="loadItems(pagination.pagina_anterior,pagination.palabra_buscada)" class="text-gray-500 hover:text-gray-900 cursor-pointer p-1 hover:bg-gray-100 rounded inline-flex justify-center">
        <i class="fas fa-chevron-left p-2"></i>
    </a>
    <a @click="loadItems(pagination.pagina_posterior,pagination.palabra_buscada)" class="text-gray-500 hover:text-gray-900 cursor-pointer p-1 hover:bg-gray-100 rounded inline-flex justify-center mr-2">
